...
loadTimesheets = function (exports) {
  ...
  Timesheets.prototype.receiveMessage = function(username, message) {
    ...
    var commands = [
      ...
      ['actionSignOut', /^\s*(:walking:|:woman-walking:|:man-walking:)?\s*(退社|taisya|退勤|作業終了)(した|しました|していました|しています|します|simasita|simasu)/],
      ...
      ['actionSignIn', /^\s*(:walking:|:woman-walking:|:man-walking:)?\s*(出社|syussya|出勤|作業開始)(した|しました|していました|しています|します|simasita|simasu)/],
      ['actionPause', /^\s*(:walking:|:woman-walking:|:man-walking:)?\s*作業中断(した|しました|します)?/],
      ['actionResume', /^\s*(:walking:|:woman-walking:|:man-walking:)?\s*作業再開(した|しました|します)?/ ],
